...
public class RangedItemIdkItem extends Item {
	public RangedItemIdkItem() {
	...
	public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				RangedItemIdkEntity entityarrow = RangedItemIdkEntity.shoot(world, entity, world.getRandom(), 10f, 10, 10);
